  ...
  return (
    <div>
      <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Pesquisar auditoria..." className="input" style={{ flex: 1 }} />
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}
                  ...
                  <td style={{ padding: '9px 14px', fontSize: 11 }}><span style={{ padding: '2px 7px', borderRadius: 4, background: 'var(--surface-3)', color: 'var(--text-2)', fontSize: 10 }}>{a.perfil}</span></td>
