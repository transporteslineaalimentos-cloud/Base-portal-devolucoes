    ...
    return (
      <div style={{ textAlign: 'center', padding: '64px 24px' }}>
        ...
        <div style={{ fontSize: 13, color: 'var(--text-3)', maxWidth: 300, margin: '0 auto' }}>
          Nenhuma cobrança vinculada à sua transportadora no momento.
        </div>
      </div>
    );
  }

  // Only show statuses visible to transporter
  const visibleStatuses = SO.filter(s =>
    ['cobr_tr', 'tr_contestou', 'tr_concordou', 'tr_nao_resp', 'emitida', 'cobrada'].includes(s.v)
  );
