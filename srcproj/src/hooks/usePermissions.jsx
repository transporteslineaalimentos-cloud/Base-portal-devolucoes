...
const FALLBACK = {
  admin:             { tabs: ['dashboard','cobranca','lancamento','acompanhamento','nfDebito','transportadores','aging','historico','auditoria','usuarios'], can_edit_cobr: true, can_edit_lanc: true, can_import: true, can_export: true, can_email: true, can_emit_nf: true, note_filter: null },
  internal:          { tabs: ['dashboard','cobranca','lancamento','acompanhamento','nfDebito','transportadores','aging','historico','auditoria'], can_edit_cobr: true, can_edit_lanc: true, can_import: true, can_export: true, can_email: true, can_emit_nf: true, note_filter: null },
