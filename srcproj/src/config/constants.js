...
export const SO = [
  ...
  { v: 'emitida',      l: 'NF débito emitida',                   c: '#10b981', bg: '#ecfdf5',
    final: false, transp: true,
    next_internal: ['cobrada'], next_transp: [] },
...
export const TK = [
  ...
  { v: 'em_transito',     l: 'Em trânsito p/ filial origem',  c: '#8b5cf6', bg: '#f5f3ff', i: '🚚',
    final: false, transp: true, hasDate: true,
    next_internal: [],
  ...
  { v: 'agend_solicitado',l: 'Agendamento solicitado',        c: '#0891b2', bg: '#ecfeff', i: '📅',
    final: false, transp: true, hasDate: true, hasAttach: true,
    next_internal: [],
    next_transp: ['agend_confirmado', 'extravio'] },
  { v: 'agend_confirmado',l: 'Agendamento confirmado',        c: '#0d9488', bg: '#f0fdfa', i: '📋', hasDate: true, hasAttach: true,
    final: false, transp: true,
    next_internal: [],
    next_transp: ['entregue', 'extravio'] },
  { v: 'entregue',        l: 'Entregue',                      c: '#059669', bg: '#ecfdf5', i: '✅', hasDate: true, hasAttach: true,
